...
; -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
Name: "KKManager";                             Description: "KKManager v1.5.1.0 (Manage plugins and browse character cards)"                       
; -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
; endif
Name: "Content\Fishbone";                      Description: "Fishbone+CoastalSmell v3.1.3 (API for character and coordinate extension data and syntax suggers)"; Types: extra extra_en
